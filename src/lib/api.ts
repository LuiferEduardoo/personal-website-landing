// Patch IPv4 solo en dev (Node). En el runtime de Cloudflare Workers no
// existen `node:net`/`node:dns`, así que se importa dinámicamente bajo un
// guard que Vite elimina del bundle de producción.
if (import.meta.env.DEV) {
  await import("./dev-ipv4");
}
